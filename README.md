...
Replication of bug in ERL-956.

* `elixir -v`

```
Erlang/OTP 22 [erts-10.4] [source] [64-bit] [smp:6:6] [ds:6:6:10] [async-threads:1] [hipe] [dtrace]
...
* Erlang is installed from the latest homebrew formula:
